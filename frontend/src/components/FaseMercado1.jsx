...
const FaseMercado1 = ({ setFase }) => {
  ...
  useEffect(() => {
    const fetchNivel = async () => {
      try {
        const res = await fetch("https://datarunnersdeploy.onrender.com/niveles/7");
    ...
    const fetchTabla = async () => {
      try {
        const res = await fetch("https://datarunnersdeploy.onrender.com/niveles/tabla/7");
        const data = await res.json();
        setTabla(data.tabla);
      } catch (err) {
  ...
  const handleConsultar = async () => {
    try {
      const res = await fetch("https://datarunnersdeploy.onrender.com/niveles/7/resolver", {
        method: "POST",
